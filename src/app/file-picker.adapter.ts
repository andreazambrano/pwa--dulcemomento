...
export class DemoFilePickerAdapter extends FilePickerAdapter {
  ...
  public uploadFile(fileItem: FilePreviewModel) {
    ...
    const api = 'http://localhost:3022/api/containers/tixsImages/upload';
    ...
    .pipe(
      map( (res: HttpEvent<any>) => {
         ...
         this._uw.images.push('http://localhost/bucketDulce/server/local-storage/tixsImages/'+this._uw.file[0].name);
